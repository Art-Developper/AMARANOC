...
const Announcement = () => {
    return (
        <>
            <div
                className="bg-no-repeat h-screen flex items-center justify-center"
                style={{
            ...
            >
                ...
                <div className=" bg-opacity-70 p-8 rounded-lg shadow-lg w-3/4 max-w-4xl border-2 border-white text-white">
