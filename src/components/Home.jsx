            ...
            <div className="max-w-7xl mx-auto flex gap-8"> 
                ...
                <div className="flex-1">
                    <div className="mb-6 flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-extrabold text-blue-800">Մեր բացառիկ առաջարկները</h1> 
                        </div>
                    </div>

                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {filteredProperties.length === 0 && (
                            <div className="col-span-full text-center text-blue-400 mt-12 text-lg"> 
                        ...
                        {paginatedProperties.map((p, idx) => ( 
                            <div
                                key={p.id || idx}
                                className="bg-white rounded-3xl shadow-xl overflow-hidden transition hover:shadow-2xl duration-400 border border-blue-100" // Փոխված rounded, shadow և ավելացված border
                            >
                                ...
                                <div className="p-5">
                                    <div className="flex items-start justify-between">
                                        ...
                                        <div className="flex items-center gap-1 bg-blue-600 text-white px-3 py-1 rounded-xl text-md font-semibold"> 
                                            <FaStar className="text-white" /> {p.rating || 0} 
                                        </div>
                                    </div>

                                    <div className="mt-4 flex items-center justify-between">
                                        <div className="text-2xl font-bold text-blue-700 transition"> 
                    ...
                    {totalPages > 1 && (
                        <div className="flex justify-center items-center gap-4 mt-12"> 
                            <button
                                ...
                                className="px-4 py-2 rounded-lg bg-blue-100 hover:bg-blue-200 disabled:opacity-50 text-blue-700 font-semibold" 
                            >
                                ← Նախորդ
                            </button>
